...
import com.WebProject.schoolmanagmentsystem.dto.*;
import com.WebProject.schoolmanagmentsystem.model.*;
import com.WebProject.schoolmanagmentsystem.service.*;
...
public class ManagementController {
    ...
    public String getStudentUpdate(Model model, @PathVariable(value = "student_id") Long student_id, HttpServletRequest request) {
        ...
        if (sessionAdmin != null) {
            ...
            StudentsModel studentsModel = studentsService.getStudentById(student_id);
